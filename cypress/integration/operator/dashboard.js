...
describe('Dashboard', () => {
  ...
  describe('List dan Filter Device', () => {
    beforeEach(() => {
      // cy.visit('/');
      cy.get('[title="Dashboard"] > .ant-menu-title-content > a', timeout).click();
    });
    ...
    describe('Overview', () => {
      it('Filter indikator online', () => {
        cy.wait(3000);
        cy.get('.ant-tabs-nav-list > :nth-child(2)', timeout).click();
        cy.get('[data-testid=sector] > .ant-select-selector > .ant-select-selection-item', timeout).click();
        cy.contains('Forming Baking', timeout).click({force: true});
        cy.wait(3000);
      ...
      it('Sorting List Filter Indicator', () => {
        ...
        cy.wait(7000);
        cy.get('[data-testid=indicator] > .ant-select-selector > .ant-select-selection-item', timeout).click();
        cy.get('.ant-select-dropdown > :nth-child(1) > .rc-virtual-list > .rc-virtual-list-holder > :nth-child(1) > .rc-virtual-list-holder-inner > .ant-select-item-option-active')
          .contains('Arus Listrik (A)', timeout);
        cy.get('.ant-select-dropdown > :nth-child(1) > .rc-virtual-list > .rc-virtual-list-holder > :nth-child(1) > .rc-virtual-list-holder-inner > [title="Daya (kW)"]', timeout)
          .contains('Daya (kW)', timeout).should('be.visible');
        cy.get('.ant-select-dropdown > :nth-child(1) > .rc-virtual-list > .rc-virtual-list-holder > :nth-child(1) > .rc-virtual-list-holder-inner > [title="Daya Aktif Kirim (W)"]')
          .contains('Daya Aktif Kirim (W)').should('be.visible');
        cy.get('.ant-select-dropdown > :nth-child(1) > .rc-virtual-list > .rc-virtual-list-holder > :nth-child(1) > .rc-virtual-list-holder-inner > [title="Daya Aktif Terima (W)"]', timeout)
          .contains('Daya Aktif Terima (W)', timeout).should('be.visible');
        cy.get('.ant-select-dropdown > :nth-child(1) > .rc-virtual-list > .rc-virtual-list-holder > :nth-child(1) > .rc-virtual-list-holder-inner > [title="Daya per Hour (kWh)"]', timeout)
          .contains('Daya per Hour (kWh)', timeout).should('be.visible'); 
        cy.get('.ant-select-dropdown > :nth-child(1) > .rc-virtual-list > .rc-virtual-list-holder > :nth-child(1) > .rc-virtual-list-holder-inner > [title="EOB Stand Aktif Energy Kirim (Wh)"]', timeout)
          .contains('EOB Stand Aktif Energy Kirim (Wh)', timeout).should('be.visible');
        cy.get('.ant-select-dropdown > :nth-child(1) > .rc-virtual-list > .rc-virtual-list-holder > :nth-child(1) > .rc-virtual-list-holder-inner > [title="EOB Stand Aktif Energy Terima (Wh)"]', timeout)
          .contains('EOB Stand Aktif Energy Terima (Wh)', timeout).should('be.visible');
        cy.get('.ant-select-dropdown > :nth-child(1) > .rc-virtual-list > .rc-virtual-list-holder > :nth-child(1) > .rc-virtual-list-holder-inner > [title="Faktor Daya (Cos φ)"]', timeout)
          .contains('Faktor Daya (Cos φ)', timeout).should('be.visible');
      });
    });
  });

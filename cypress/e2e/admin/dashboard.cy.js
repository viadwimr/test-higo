...
describe('Dashboard', () => {
  ...
  describe('Melihat halaman utama Dashboard Energy Monitoring (Main View)', () => {
    it('Menampilkan tabel Akumulasi Energi DMIA seperti informasi target, aktual dan evaluasinya per indikator yaitu Energi dan Index', () => {
      ...
      cy.get('.ant-table-thead > tr > :nth-child(1)', timeout)
      .contains('May 2023')
      cy.get('.ant-table-thead > tr > :nth-child(2)', timeout)
      .contains('Target')
      cy.get('.ant-table-thead > tr > :nth-child(3)', timeout)
      .contains('Aktual')
      cy.get('.ant-table-thead > tr > :nth-child(4)', timeout)
      .contains('Evaluasi')
      cy.get('[data-row-key="daya_hour"] > :nth-child(1)', timeout)
      .contains('Energi')
      cy.get('[data-row-key="index"] > :nth-child(1)', timeout)
      .contains('Index')
    });
    ...
    it('Menampilkan Akumulasi Energi Per Plant yaitu DMIA 1, DMIA 2, dan DMIA 3. Dan setiap plant terdapat grafik bar Energi dan grafik line Index per bulannya dalam setahun serta terdapat grafik nilai average di ujung kanan grafik.', () => {
      ...
      */
      ...
      cy.get(':nth-child(3) > .ant-card-body > [style=""] > [style="display: flex; justify-content: space-between;"] > p', timeout)
        .should('not.exist')
      cy.get('canvas', timeout).eq(3).should('not.exist')
    });
  });
  ...
  describe('Melihat halaman utama Dashboard Energy Monitoring (Plant View)', () => {   
    it('Menampilkan tabel Akumulasi Energi DMIA 1 seperti informasi target, aktual dan evaluasinya per indikator yaitu Energi dan Index', () => {
      ...
      cy.get('[style="width: 100%;"] > .ant-card-body > [style="display: flex; justify-content: space-between;"] > h3', timeout)
      .contains('Akumulasi Energi DMIA');
      cy.get('[data-testid="table"] > .ant-table-container > .ant-table-content > table > .ant-table-thead > tr > :nth-child(1)', timeout)
      .contains('May 2023')
      cy.get('[data-testid="table"] > .ant-table-container > .ant-table-content > table > .ant-table-thead > tr > :nth-child(2)', timeout)
      .contains('Target')
      cy.get('[data-testid="table"] > .ant-table-container > .ant-table-content > table > .ant-table-thead > tr > :nth-child(3)', timeout)
      .contains('Aktual')
      cy.get('[data-testid="table"] > .ant-table-container > .ant-table-content > table > .ant-table-thead > tr > :nth-child(4)', timeout)
      .contains('Evaluasi')
      cy.get('[data-testid="table"] > .ant-table-container > .ant-table-content > table > .ant-table-tbody > [data-row-key="daya_hour"] > :nth-child(1)', timeout)
      .contains('Energi')
      cy.get('[data-testid="table"] > .ant-table-container > .ant-table-content > table > .ant-table-tbody > [data-row-key="index"] > :nth-child(1)', timeout)
      .contains('Index')
    });
  ...
  describe('Melihat halaman utama Dashboard Energy Monitoring (Building View)', () => {   
    it('Menampilkan tabel Akumulasi Energi Gedung 1 seperti informasi target, aktual dan evaluasinya per indikator yaitu Energi dan Index', () => {
      ...
      cy.get('[style="width: 100%;"] > .ant-card-body > [data-testid="data-chart"] > .DetailChart__TableWrapper-fb3pmn-0 > [style="width: 60%;"] > .ant-spin-nested-loading > .ant-spin-container > [data-testid="table"] > .ant-table-container > .ant-table-content > table > .ant-table-thead > tr > :nth-child(1)', timeout)
      .contains('May 2023')
      cy.get('[style="width: 100%;"] > .ant-card-body > [data-testid="data-chart"] > .DetailChart__TableWrapper-fb3pmn-0 > [style="width: 60%;"] > .ant-spin-nested-loading > .ant-spin-container > [data-testid="table"] > .ant-table-container > .ant-table-content > table > .ant-table-thead > tr > :nth-child(2)', timeout)
      .contains('Target')
      cy.get('[style="width: 100%;"] > .ant-card-body > [data-testid="data-chart"] > .DetailChart__TableWrapper-fb3pmn-0 > [style="width: 60%;"] > .ant-spin-nested-loading > .ant-spin-container > [data-testid="table"] > .ant-table-container > .ant-table-content > table > .ant-table-thead > tr > :nth-child(3)', timeout)
      .contains('Aktual')
      cy.get('[style="width: 100%;"] > .ant-card-body > [data-testid="data-chart"] > .DetailChart__TableWrapper-fb3pmn-0 > [style="width: 60%;"] > .ant-spin-nested-loading > .ant-spin-container > [data-testid="table"] > .ant-table-container > .ant-table-content > table > .ant-table-thead > tr > :nth-child(4)', timeout)
      .contains('Evaluasi')
      cy.get('[style="width: 100%;"] > .ant-card-body > [data-testid="data-chart"] > .DetailChart__TableWrapper-fb3pmn-0 > [style="width: 60%;"] > .ant-spin-nested-loading > .ant-spin-container > [data-testid="table"] > .ant-table-container > .ant-table-content > table > .ant-table-tbody > [data-row-key="daya_hour"] > :nth-child(1)', timeout)
      .contains('Energi')
      cy.get('[style="width: 100%;"] > .ant-card-body > [data-testid="data-chart"] > .DetailChart__TableWrapper-fb3pmn-0 > [style="width: 60%;"] > .ant-spin-nested-loading > .ant-spin-container > [data-testid="table"] > .ant-table-container > .ant-table-content > table > .ant-table-tbody > [data-row-key="index"] > :nth-child(1)', timeout)
      .contains('Index')
    });
    ...
    it('Pada card Mesin Produksi, terdapat tambahan tampilan Akumulasi Energi Per Line yaitu Arm BF 23 Line 1, Arm BF 23 Line 2 dll yang setiap line nya terdapat grafik bar Energi dan grafik line Index per bulannya dalam setahun serta terdapat grafik nilai average di ujung kanan grafik.', () => {
      // bug: Per Line
      cy.get('section > h3', timeout).contains('Akumulasi Energi Per Line')
      // Line 1
      cy.get(':nth-child(1) > .ant-card-body > [style=""] > [style="display: flex; justify-content: space-between;"] > h4', timeout)
  ...
  describe('Melihat halaman utama Dashboard Energy Monitoring (Item View)', () => {
    ...
    it('Menampilkan Akumulasi Energi Per Line yaitu Arm BF 23 Line 1, Arm BF 23 Line 2 dll yang setiap line nya terdapat grafik bar Energi dan grafik line Index per bulannya dalam setahun serta terdapat grafik nilai average di ujung kanan grafik.', () => {
      ...
      cy.wait(3000);
      cy.get('.ant-layout-content').contains('Arm BF 23 Line 1', timeout).should('be.visible');
      cy.get('.ant-layout-content').contains('Arm BF 23 Line 2', timeout).should('not.exist');
      cy.get('body').find('canvas').then((graphic) => {
        var graphicCount = Cypress.$(graphic).length;
        expect(graphicCount).to.be.equal(1)
      })
      ...
      cy.get('[data-testid="button-sector-filter"]', timeout).click();
      cy.get('.ant-layout-content').contains('Arm BF 23 Line 1', timeout).should('be.visible');
      cy.get('.ant-layout-content').contains('Arm BF 23 Line 2', timeout).should('be.visible');
      cy.get('body').find('canvas').then((graphic) => {
        var graphicCount = Cypress.$(graphic).length;
        expect(graphicCount).to.be.equal(2)
      })

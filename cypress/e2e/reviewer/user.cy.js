...
describe('User', () => {
  ...
  describe('Tambah User (Admin Only)', () => {
    ...
    it.skip('Menampilkan Form Tambah User bagian ID', () => {
    ...
    it.skip('Menampilkan notifikasi berhasil dan data user berhasil ditambahkan', () => {
  ...
  describe('Edit User', () => {
    it.skip('Menampilkan Form Edit User', () => {
    ...
    it.skip('Menampilkan notifikasi berhasil dan data user berhasil diedit', () => {
      cy.contains('Berhasil', timeout).should('be.visible');
      // check after edit
      cy.wait(3000);
  ...
  describe('Hapus User', () => {
    it.skip('Menampilkan notifikasi konfirmasi hapus', () => {
      cy.wait(3000);
    ...
    it.skip('Menampilkan notifikasi berhasil dan data user berhasil dihapus', () => {
      cy.contains('Berhasil', timeout).should('be.visible');
      // check after edit
      cy.wait(3000);
